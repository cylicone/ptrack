...
// getAppPaths returns file paths for data and log inside ~/.ptracker
...
// loadTracker reads tracker data or initializes new
...
// saveTracker writes tracker data to file
...
// projectExists checks for project name
